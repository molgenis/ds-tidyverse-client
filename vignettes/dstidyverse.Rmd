...
ds.colnames("new_df")
#> $sim1
#>  [1] "mpg"       "cyl"       "mpg_trans" "new_var"   "disp"      "hp"        "drat"      "wt"        "qsec"      "vs"       
#> [11] "am"        "gear"      "carb"
```
...
#> $sim1
#>  [1] "where_it_came_from" "mpg"                "cyl"                "disp"               "hp"                
...
ds.colnames("df_bound")
#> $sim1
#>  [1] "mpg...1"   "cyl...2"   "disp...3"  "hp...4"    "drat...5"  "wt...6"    "qsec...7"  "vs...8"    "am...9"    "gear...10"
#> [11] "carb...11" "mpg...12"  "cyl...13"  "disp...14" "hp...15"   "drat...16" "wt...17"   "qsec...18" "vs...19"   "am...20"  
#> [21] "gear...21" "carb...22"
```
...
ds.colnames("df_bound")
#> $sim1
#>  [1] "mpg"  "cyl"  "disp" "hp"   "drat" "wt"   "qsec" "vs"   "am"   "gear" "carb" "mpg"  "cyl"  "disp" "hp"   "drat" "wt"  
#> [18] "qsec" "vs"   "am"   "gear" "carb"
```
### case_when
...
#> ✖ [1m[33msim1[39m: DataSHIELD configuration does not allow expression: caseWhenDS Supported function calls are: absDS, asCharacterDS,[22m
#>   [1masDataMatrixDS, asFactorDS2, asFactorSimpleDS, asIntegerDS, asListDS, asLogicalDS, asMatrixDS, asNumericDS, blackBoxDS,[22m
#>   [1mblackBoxRanksDS, BooleDS, boxPlotGG_data_TreatmentDS, boxPlotGG_data_Treatment_numericDS, bp_standardsDS, cbindDS, cDS,[22m
#>   [1mchangeRefGroupDS, completeCasesDS, dataFrameDS, dataFrameFillDS, dataFrameSortDS, dataFrameSubsetDS2, dmtC2SDS,[22m
#>   [1melsplineDS, glmerSLMADS.assign, glmPredictDS.as, glmSLMADS.assign, glmSummaryDS.as, getWGSRDS, igb_standardsDS, listDS,[22m
#>   [1mlexisDS2, lexisDS3, lmerSLMADS.assign, lsplineDS, matrixDetDS2, matrixDiagDS, matrixDimnamesDS, matrixDS, matrixInvertDS,[22m
#>   [1mmatrixMultDS, matrixTransposeDS, mergeDS, nsDS, qlsplineDS, ranksSecureDS2, ranksSecureDS4, ranksSecureDS5, rbindDS,[22m
#>   [1mrBinomDS, recodeLevelsDS, recodeValuesDS, repDS, replaceNaDS, reShapeDS, rNormDS, rowColCalcDS, rPoisDS, rUnifDS,[22m
#>   [1msampleDS, seqDS, sqrtDS, subsetByClassDS, subsetDS, tableDS.assign, tapplyDS.assign, uniqueDS, unListDS, vectorDS,[22m
#>   [1mas.character, as.null, as.numeric, attach, c, complete.cases, list, exp, log, sqrt, abs, sin, cos, tan, asin, acos, atan,[22m
#>   [1msum, unlist, selectDS, renameDS, mutateDS, ifElseDS, bindRowsDS, bindColsDS[22m
```

``` r

ds.table("recoded")$output.list$TABLE_rvar.by.study_counts
#> Error: The input object recoded is not defined in sim1!
```
...
#> Error: The input object recoded_missing is not defined in sim1!
```
